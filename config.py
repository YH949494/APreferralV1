...
# ---------------------------------------------------------------------------
# Campaign Centre / Tournament Reward Integration (secure defaults: approval
# required, auto-allocation disabled).
# ---------------------------------------------------------------------------
CAMPAIGN_CENTRE_ENABLED = os.getenv("CAMPAIGN_CENTRE_ENABLED", "1") == "1"
TOURNAMENT_INTEGRATION_ENABLED = os.getenv("TOURNAMENT_INTEGRATION_ENABLED", "1") == "1"
CAMPAIGN_PROVIDER_HMAC_TOLERANCE_S = int(os.getenv("CAMPAIGN_PROVIDER_HMAC_TOLERANCE_S", "300"))
CAMPAIGN_PROVIDER_NONCE_TTL_S = int(os.getenv("CAMPAIGN_PROVIDER_NONCE_TTL_S", "600"))
TOURNAMENT_MAX_WINNERS = int(os.getenv("TOURNAMENT_MAX_WINNERS", "500"))
CAMPAIGN_DEFAULT_CHANNEL_ID = os.getenv("OFFICIAL_CHANNEL_ID", "")
CAMPAIGN_DEFAULT_CHANNEL_USERNAME = os.getenv("OFFICIAL_CHANNEL_USERNAME", "")
CAMPAIGN_RESULT_APPROVAL_REQUIRED = os.getenv("CAMPAIGN_RESULT_APPROVAL_REQUIRED", "1") == "1"
CAMPAIGN_AUTO_ALLOCATE_ENABLED = os.getenv("CAMPAIGN_AUTO_ALLOCATE_ENABLED", "0") == "1"
CAMPAIGN_REWARDS_ENABLED = os.getenv("CAMPAIGN_REWARDS_ENABLED", "1") == "1"
CAMPAIGN_MAX_ACTIVE_CARDS = int(os.getenv("CAMPAIGN_MAX_ACTIVE_CARDS", "10"))
CAMPAIGN_REWARD_DEFAULT_EXPIRY_DAYS = int(os.getenv("CAMPAIGN_REWARD_DEFAULT_EXPIRY_DAYS", "0"))  # 0 = never
CAMPAIGN_SUBSCRIPTION_CACHE_TTL_S = int(os.getenv("CAMPAIGN_SUBSCRIPTION_CACHE_TTL_S", "300"))
