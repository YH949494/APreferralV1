...
(function () {
  ...
  const I18N = {
    en: {
      ...
      try_again: "Try again",
      referral_generate_error: "Couldn't generate your link. Please try again.",
      referral_manual_copy: "Link generated — long press to copy",
      share: "📤 Share",
    ...
    th: {
      ...
      referral_generate_error: "ไม่สามารถสร้างลิงก์ได้ กรุณาลองอีกครั้ง",
      referral_manual_copy: "สร้างลิงก์แล้ว — กดค้างเพื่อคัดลอก",
      share: "📤 แชร์",
    ...
    id: {
      ...
      generating: "Membuat…",
      try_again: "Coba lagi",
      referral_generate_error: "Tidak dapat membuat link Anda. Silakan coba lagi.",
      referral_manual_copy: "Link dibuat — tekan lama untuk menyalin",
      share: "📤 Bagikan",
