...
(function () {
  ...
  const I18N = {
    en: {
      ...
      copy: "📋 Copy",
      copy_link: "📋 Copy link",
      copy_caption_link: "📋 Copy caption + link",
      copied_check: "✅ Copied",
      generating: "Generating…",
      try_again: "Try again",
      referral_generate_error: "Unable to generate your referral link. Try again.",
      referral_manual_copy: "Caption generated — long press to copy",
      share: "📤 Share",
      ...
      welcome_step_of: "Step {step} of {required}",
      welcome_checkin_label: "Check-in {day}",
      welcome_progress_zero: "Complete {required} check-ins within 7 days to unlock your reward.",
      welcome_progress_one_left: "Check-in {completed} completed — 1 more check-in to unlock your reward.",
      welcome_progress_many_left: "Check-in {completed} completed — {remaining} more check-ins to unlock your reward.",
      welcome_checkins_done_verify_channel: "Check-ins complete — please verify your channel subscription to unlock your reward.",
      welcome_status_badge_ready: "🎁 Ready to Claim",
      welcome_status_badge_claimed: "✅ Claimed",
      welcome_status_message_ready: "Your Welcome Reward has been unlocked.",
      welcome_status_message_claimed: "Your Welcome Reward has been claimed.",
      welcome_status_issued_label: "Issued: {date}",
    ...
    th: {
      ...
      channel_joined: "เข้าร่วมช่องทางการแล้ว",
      channel_join_required: "เข้าร่วมช่องทางการ",
      channel_required_to_claim: "จำเป็นสำหรับการรับรางวัล",
      channel_checking_status: "กำลังตรวจสอบสถานะช่องทางการ…",
      ...
      copy_caption_link: "📋 คัดลอกแคปชัน + ลิงก์",
      copied_check: "✅ คัดลอกแล้ว",
      generating: "กำลังสร้าง…",
      try_again: "ลองอีกครั้ง",
      referral_generate_error: "ไม่สามารถสร้างลิงก์แนะนำของคุณได้ กรุณาลองอีกครั้ง",
      referral_manual_copy: "สร้างแคปชันแล้ว — กดค้างเพื่อคัดลอก",
      share: "📤 แชร์",
      ...
      welcome_step_of: "ขั้นตอน {step} จาก {required}",
      welcome_checkin_label: "เช็คอิน {day}",
      welcome_progress_zero: "เช็คอินให้ครบ {required} ครั้งภายใน 7 วันเพื่อปลดล็อครางวัลของคุณ",
      welcome_progress_one_left: "เช็คอินครบ {completed} ครั้งแล้ว — อีก 1 ครั้งเพื่อปลดล็อครางวัลของคุณ",
      welcome_progress_many_left: "เช็คอินครบ {completed} ครั้งแล้ว — อีก {remaining} ครั้งเพื่อปลดล็อครางวัลของคุณ",
      welcome_checkins_done_verify_channel: "เช็คอินครบแล้ว — กรุณายืนยันการติดตามช่องเพื่อปลดล็อครางวัลของคุณ",
      welcome_status_badge_ready: "🎁 พร้อมรับรางวัล",
      welcome_status_badge_claimed: "✅ รับแล้ว",
      welcome_status_message_ready: "รางวัลต้อนรับของคุณปลดล็อคแล้ว",
      welcome_status_message_claimed: "คุณได้รับรางวัลต้อนรับแล้ว",
      welcome_status_issued_label: "ออกให้เมื่อ: {date}",
    ...
    id: {
      ...
      channel_joined: "Sudah Gabung Saluran Resmi",
      channel_join_required: "Gabung Saluran Resmi",
      channel_required_to_claim: "Wajib untuk klaim",
      channel_checking_status: "Memeriksa status saluran…",
      ...
      copy_caption_link: "📋 Salin caption + link",
      copied_check: "✅ Tersalin",
      generating: "Membuat…",
      try_again: "Coba lagi",
      referral_generate_error: "Tidak dapat membuat link referral Anda. Silakan coba lagi.",
      referral_manual_copy: "Teks caption dibuat — tekan lama untuk menyalin",
      share: "📤 Bagikan",
      ...
      welcome_step_of: "Langkah {step} dari {required}",
      welcome_checkin_label: "Check-in {day}",
      welcome_progress_zero: "Selesaikan {required} check-in dalam 7 hari untuk membuka hadiah Anda.",
      welcome_progress_one_left: "Check-in {completed} selesai — 1 check-in lagi untuk membuka hadiah Anda.",
      welcome_progress_many_left: "Check-in {completed} selesai — {remaining} check-in lagi untuk membuka hadiah Anda.",
      welcome_checkins_done_verify_channel: "Check-in selesai — silakan verifikasi langganan saluran Anda untuk membuka hadiah Anda.",
      welcome_status_badge_ready: "🎁 Siap Diklaim",
      welcome_status_badge_claimed: "✅ Diklaim",
      welcome_status_message_ready: "Hadiah Selamat Datang Anda telah dibuka.",
      welcome_status_message_claimed: "Hadiah Selamat Datang Anda telah diklaim.",
      welcome_status_issued_label: "Diterbitkan: {date}",
